...
class Driver(BaseDriver):
    ...
    def pre_run(self):
        ...
        if self.model_str == 'faster_whisper' :
            ...
            self.pipe = WhisperModel(model_size_or_path = 'core/hal/drivers/speech_to_text/models/models--Systran--faster-whisper-medium.en/snapshots/a29b04bd15381511a9af671baec01072039215e3', device=self.device, compute_type="int8")
