...
from core.hal.drivers.speech_to_text.fast_whisper.tokenizer import Tokenizer
from core.hal.drivers.speech_to_text.fast_whisper.feature_extractor import FeatureExtractor
...
from core.hal.drivers.speech_to_text.fast_whisper.vad import (
    SpeechTimestampsMap,
    VadOptions,
    collect_chunks,
...
from core.hal.drivers.speech_to_text.fast_whisper.utils import (
    decode_audio,
...
class WhisperModel:
    def __init__(
        ...
        if os.path.isfile(tokenizer_file):
            print('tokenizer path : ',tokenizer_file)
